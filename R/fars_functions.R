...
#'
#' @description
#' Reads and loads a CSV file defined by \code{filename} argument
#' Returns a tibble
#' If the path is incorrect the function will end with an error.
#'
#' @param filename Path to the CSV file (character)
#'
#' @return Returns a tibble from the CSV file
#'
#' @examples
#' \dontrun{
...
#'
#' @description
#' Creates a filename for a .csv.bz2 file based on the \code{year}
...
#'
#' @description
#' Takes a vector or list of years and returns a list of data frames
...
#'
#' @description
#' Calculates the number of accidents in the US on a monthly basis.
...
#'
#' @return Returns a pivot tibble with months in rows and selected
...
#' Plots the accidents on a map
#'
#' @description
#' Takes a state number and year and plots the accidents in a
#' simple map. The state number should be integer or numerical and should exist
#' in the FARS data, otherwise the function terminates with an error.
